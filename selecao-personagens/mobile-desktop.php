...
function montarTelaSelecaoPersonagem($suspeitos, $class = 'col-md-6'){
    ...
    foreach ($suspeitos as $s) {
        ...
        $html .=      '<a href="./index.php?etapa=4&jogador=' . $s["codigo"] . '"><img width="400" src="./assets/imagens/suspeitos/' . $s["imagem"] . '" class="img-fluid border-geral imagem-com-borda" onclick="btnVibrate();"></a>';
        $html .= '</div>';
    }
    $html .= '</div>';
    return $html;
